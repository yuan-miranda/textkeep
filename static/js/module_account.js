...
export function displayUserData(user) {
    ...
    document.getElementById("account-date-updated").textContent = user.account_date_updated || "N/A";
    document.getElementById("account-date-deleted").textContent = user.account_date_deleted;
    document.getElementById("storage-used").textContent = user.storage_used;
}